...
function LaptopReservationPage() {
  ...
  const handleReserve = async (laptop) => {
    ...
    // Si no lo hizo, mostramos modal, pero el botón en la tarjeta SÍ era clickeable.
    ...
    if (!usuario || !usuario.id) {
      showError("Usuario no identificado. Por favor inicie sesión nuevamente.", "Error de sesión");
      return;
    }
    ...
    try {
      ...
      showError(`Error de conexión: ${error.message}`, "Error de conexión");
    }
  };
